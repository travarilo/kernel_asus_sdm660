...
static unsigned char aw87339_kspk_cfg_default[] = { 0x39, 0x0E, 0xA3, 0x06,
						    0x05, 0x10, 0x07, 0x52,
						    0x06, 0x08, 0x96 };
static unsigned char aw87339_drcv_cfg_default[] = { 0x39, 0x0A, 0xAB, 0x06,
						    0x05, 0x00, 0x0f, 0x52,
						    0x09, 0x08, 0x97 };
static unsigned char aw87339_abrcv_cfg_default[] = { 0x39, 0x0A, 0xAF, 0x06,
						     0x05, 0x00, 0x0f, 0x52,
						     0x09, 0x08, 0x97 };
static unsigned char aw87339_rcvspk_cfg_default[] = { 0x39, 0x0E, 0xB3, 0x06,
						      0x05, 0x00, 0x07, 0x52,
						      0x06, 0x08, 0x96 };
...
unsigned char aw87339_audio_kspk_spk(void)
{
	...
	i2c_write_reg(AW87339_REG_SYSCTRL,
		      aw87339_kspk_reg_val(AW87339_REG_SYSCTRL) & 0xF7);
	i2c_write_reg(AW87339_REG_MODECTRL,
		      aw87339_kspk_reg_val(AW87339_REG_MODECTRL));
	i2c_write_reg(AW87339_REG_CPOVP,
		      aw87339_kspk_reg_val(AW87339_REG_CPOVP));
	...
	i2c_write_reg(AW87339_REG_AGC3_PO,
		      aw87339_kspk_reg_val(AW87339_REG_AGC3_PO));
	i2c_write_reg(AW87339_REG_AGC3, aw87339_kspk_reg_val(AW87339_REG_AGC3));
	i2c_write_reg(AW87339_REG_AGC2_PO,
		      aw87339_kspk_reg_val(AW87339_REG_AGC2_PO));
	...
	i2c_write_reg(AW87339_REG_SYSCTRL,
		      aw87339_kspk_reg_val(AW87339_REG_SYSCTRL));
...
unsigned char aw87339_audio_drcv_spk(void)
{
	...
	i2c_write_reg(AW87339_REG_SYSCTRL,
		      aw87339_drcv_reg_val(AW87339_REG_SYSCTRL) & 0xF7);
	i2c_write_reg(AW87339_REG_MODECTRL,
		      aw87339_drcv_reg_val(AW87339_REG_MODECTRL));
	i2c_write_reg(AW87339_REG_CPOVP,
		      aw87339_drcv_reg_val(AW87339_REG_CPOVP));
	...
	i2c_write_reg(AW87339_REG_AGC3_PO,
		      aw87339_drcv_reg_val(AW87339_REG_AGC3_PO));
	i2c_write_reg(AW87339_REG_AGC3, aw87339_drcv_reg_val(AW87339_REG_AGC3));
	i2c_write_reg(AW87339_REG_AGC2_PO,
		      aw87339_drcv_reg_val(AW87339_REG_AGC2_PO));
	...
	i2c_write_reg(AW87339_REG_SYSCTRL,
		      aw87339_drcv_reg_val(AW87339_REG_SYSCTRL));
...
unsigned char aw87339_audio_abrcv_spk(void)
{
	...
	i2c_write_reg(AW87339_REG_SYSCTRL,
		      aw87339_abrcv_reg_val(AW87339_REG_SYSCTRL) & 0xF7);
	i2c_write_reg(AW87339_REG_MODECTRL,
		      aw87339_abrcv_reg_val(AW87339_REG_MODECTRL));
	i2c_write_reg(AW87339_REG_CPOVP,
		      aw87339_abrcv_reg_val(AW87339_REG_CPOVP));
	i2c_write_reg(AW87339_REG_CPP, aw87339_abrcv_reg_val(AW87339_REG_CPP));
	i2c_write_reg(AW87339_REG_GAIN,
		      aw87339_abrcv_reg_val(AW87339_REG_GAIN));
	i2c_write_reg(AW87339_REG_AGC3_PO,
		      aw87339_abrcv_reg_val(AW87339_REG_AGC3_PO));
	i2c_write_reg(AW87339_REG_AGC3,
		      aw87339_abrcv_reg_val(AW87339_REG_AGC3));
	i2c_write_reg(AW87339_REG_AGC2_PO,
		      aw87339_abrcv_reg_val(AW87339_REG_AGC2_PO));
	i2c_write_reg(AW87339_REG_AGC2,
		      aw87339_abrcv_reg_val(AW87339_REG_AGC2));
	i2c_write_reg(AW87339_REG_AGC1,
		      aw87339_abrcv_reg_val(AW87339_REG_AGC1));
	i2c_write_reg(AW87339_REG_SYSCTRL,
		      aw87339_abrcv_reg_val(AW87339_REG_SYSCTRL));
...
unsigned char aw87339_audio_rcvspk_spk(void)
{
	...
	i2c_write_reg(AW87339_REG_SYSCTRL,
		      aw87339_rcvspk_reg_val(AW87339_REG_SYSCTRL) & 0xF7);
	i2c_write_reg(AW87339_REG_MODECTRL,
		      aw87339_rcvspk_reg_val(AW87339_REG_MODECTRL));
	i2c_write_reg(AW87339_REG_CPOVP,
		      aw87339_rcvspk_reg_val(AW87339_REG_CPOVP));
	i2c_write_reg(AW87339_REG_CPP, aw87339_rcvspk_reg_val(AW87339_REG_CPP));
	i2c_write_reg(AW87339_REG_GAIN,
		      aw87339_rcvspk_reg_val(AW87339_REG_GAIN));
	i2c_write_reg(AW87339_REG_AGC3_PO,
		      aw87339_rcvspk_reg_val(AW87339_REG_AGC3_PO));
	i2c_write_reg(AW87339_REG_AGC3,
		      aw87339_rcvspk_reg_val(AW87339_REG_AGC3));
	i2c_write_reg(AW87339_REG_AGC2_PO,
		      aw87339_rcvspk_reg_val(AW87339_REG_AGC2_PO));
	i2c_write_reg(AW87339_REG_AGC2,
		      aw87339_rcvspk_reg_val(AW87339_REG_AGC2));
	i2c_write_reg(AW87339_REG_AGC1,
		      aw87339_rcvspk_reg_val(AW87339_REG_AGC1));
	i2c_write_reg(AW87339_REG_SYSCTRL,
		      aw87339_rcvspk_reg_val(AW87339_REG_SYSCTRL));
...
static void aw87339_abrcv_cfg_loaded(const struct firmware *cont, void *context)
{
	...
	ret = request_firmware_nowait(THIS_MODULE, FW_ACTION_HOTPLUG,
				      aw87339_rcvspk_name,
				      &aw87339->i2c_client->dev, GFP_KERNEL,
				      NULL, aw87339_rcvspk_cfg_loaded);
	if (ret) {
		aw87339->rcvspk_cfg_update_flag = 0;
		pr_err("%s: request_firmware_nowait failed with read %s",
		       __func__, aw87339_rcvspk_name);
 ...
 * aw87339 attribute
 ******************************************************************************/
static ssize_t aw87339_get_reg(struct device *cd, struct device_attribute *attr,
			       char *buf)
{
...
static ssize_t aw87339_set_reg(struct device *cd, struct device_attribute *attr,
...
static ssize_t aw87339_get_hwen(struct device *cd,
...
static ssize_t aw87339_set_hwen(struct device *cd,
...
static ssize_t aw87339_get_update(struct device *cd,
				  struct device_attribute *attr, char *buf)
{
	ssize_t len = 0;
...
static ssize_t aw87339_set_update(struct device *cd,
...
static struct attribute *aw87339_attributes[] = { &dev_attr_reg.attr,
						  &dev_attr_hwen.attr,
 ...
 * aw87339 i2c driver
 ******************************************************************************/
static int aw87339_i2c_probe(struct i2c_client *client,
			     const struct i2c_device_id *id)
{
	...
	aw87339 = devm_kzalloc(&client->dev, sizeof(struct aw87339_spk_t),
			       GFP_KERNEL);
	if (aw87339 == NULL) {
		err = -ENOMEM;
		goto exit_check_functionality_failed;
...
static const struct i2c_device_id aw87339_i2c_id[] = { { AW87339_I2C_NAME, 0 },
						       {} };
